...
class CubismModelSettingJson : public ICubismModelSetting,
 ...
 public:
  ...
  /**
   * Returns the name of Audio File attached to the Motion in the Motion
   * Group.
   *
   * @param groupName Name to the desired Motion Group
   * @param index Index to the desired Motion
   ...
   */
  const csmChar *GetMotionSoundFileName(const csmChar *groupName,
                                        csmInt32 index);
   ...
   */
  csmFloat32 GetMotionFadeOutTimeValue(const csmChar *groupName,
                                       csmInt32 index);
 ...
 private:
  ...
  /**
   * Returns whether the MOC3 File information exists in the Model Settings
   * File.
   *
  ...
  /**
   * Returns whether Texture File information exists in the Model Settings
   * File.
   *
  ...
  /**
   * Returns whether Physics Settings File information exists in the Model
   * Settings File.
   *
  ...
  /**
   * Returns whether Pose Settings File information exists in the Model
   * Settings File.
   *
  ...
  /**
   * Returns whether Display Settings File information exists in the Model
   * Settings File.
   *
  ...
  /**
   * Returns whether Expression File information exists in the Model Settings
   * File.
   *
  ...
  /**
   * Returns whether Motion Group information exists in the Model Settings
   * File.
   *
   * @return true if Motion Group information exists; otherwise false
   */
  ...
  /**
   * Returns the Motion Group information with the specified name in the Model
   * Settings File.
   *
   * @param groupName Name of the desired Motion Group
   *
  ...
  /**
   * Returns whether the Audio File information in the Motion Group with the
   * specified name in the Model Settings File.
   *
   * @param groupName Name of the desired Motion Group
   * @param index Index to the desired Motion
   *
   ...
   */
  csmBool IsExistMotionSoundFile(const csmChar *groupName,
                                 csmInt32 index) const;

  /**
   * Returns whether the Fade-in time at the start of Motion in Motion Group
   * with the specified name exists in Model Setting File.
   *
   * @param groupName Name of the desired Motion Group
   * @param index Index to the desired Motion
   *
  ...
  /**
   * Returns whether the Fade-out time at the end of the Motion in the Motion
   * Group with the specified name in the Model Settings File.
   *
   * @param groupName Name of the desired Motion Group
   * @param index Index to the desired Motion
   *
  ...
  /**
   * Returns whether the User Data File information exists in the Model
   * Settings File.
   *
  ...
  /**
   * Returns whether the parameter information attached to the Eye Blinking
   * Settings exists in the Model Settings File.
   *
  ...
  /**
   * Returns whether the parameter information attached to the Lip-sync
   * Settings exists in the Model Settings File.
   *
   * @return true if parameter information exists; otherwise false
   */
