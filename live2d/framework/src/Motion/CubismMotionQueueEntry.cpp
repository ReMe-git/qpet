...
void CubismMotionQueueEntry::StartFadeout(csmFloat32 fadeOutSeconds,
...
csmBool CubismMotionQueueEntry::IsFinished() const { return _finished; }

csmBool CubismMotionQueueEntry::IsStarted() const { return _started; }
...
void CubismMotionQueueEntry::IsFinished(csmBool f) { this->_finished = f; }

void CubismMotionQueueEntry::IsStarted(csmBool f) { this->_started = f; }

csmBool CubismMotionQueueEntry::IsAvailable() const { return _available; }

void CubismMotionQueueEntry::IsAvailable(csmBool v) { this->_available = v; }

void CubismMotionQueueEntry::SetState(csmFloat32 timeSeconds,
                                      csmFloat32 weight) {
...
ACubismMotion* CubismMotionQueueEntry::GetCubismMotion() { return _motion; }
