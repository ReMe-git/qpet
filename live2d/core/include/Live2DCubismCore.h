 ...
 *
 * Use of this source code is governed by the Live2D Proprietary Software
 ...
 */
csmApi csmMocVersion csmCallingConvention
 ...
 *
 * @param  address  Address of unrevived moc. The address must be aligned to
 * 'csmAlignofMoc'.
 * @param  size     Size of moc (in bytes).
 *
 * @return  '1' if Moc is valid; '0' otherwise.
 */
csmApi int csmCallingConvention csmHasMocConsistency(void *address,
 ...
 */
csmApi csmMoc *csmCallingConvention
csmReviveMocInPlace(void *address, const unsigned int size);
 ...
 * @param  address  Address to place instance at. Address must be aligned to
 * 'csmAlignofModel'.
 * @param  size     Size of memory block for instance (in bytes).
 *
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi csmModel *csmCallingConvention csmInitializeModelInPlace(
    const csmMoc *moc, void *address, const unsigned int size);
 ...
 */
csmApi void csmCallingConvention
 ...
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi const char **csmCallingConvention
 ...
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi const csmParameterType *csmCallingConvention
 ...
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi const float *csmCallingConvention
 ...
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi const int *csmCallingConvention
 ...
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi const csmFlags *csmCallingConvention
 ...
 */
csmApi const csmVector2 **csmCallingConvention
 ...
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi const unsigned short **csmCallingConvention
 ...
 * @return  Valid pointer on success; '0' otherwise.
 */
csmApi const csmVector4 *csmCallingConvention
