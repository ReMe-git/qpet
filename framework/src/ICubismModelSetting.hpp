 ...
 *
 * @note Inherit this interface if you need to extend model settings or
 * implement a class that uses model settings.
 */
class ICubismModelSetting {
 public:
   ...
   */
  virtual const csmChar *GetMotionFileName(const csmChar *groupName,
                                           csmInt32 index) = 0;
   ...
   */
  virtual const csmChar *GetMotionSoundFileName(const csmChar *groupName,
                                                csmInt32 index) = 0;
   ...
   */
  virtual csmFloat32 GetMotionFadeInTimeValue(const csmChar *groupName,
                                              csmInt32 index) = 0;
   ...
   */
  virtual csmFloat32 GetMotionFadeOutTimeValue(const csmChar *groupName,
                                               csmInt32 index) = 0;
