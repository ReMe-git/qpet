...
class CubismModel {
 ...
 public:
  ...
  struct DrawableColorData {
     ...
     * @brief   コンストラクタ
     */
    DrawableColorData() : IsOverwritten(false), Color(){};

    /**
     * @brief   コンストラクタ
     */
    DrawableColorData(csmBool isOverwritten,
                      Rendering::CubismRenderer::CubismTextureColor color)
        : IsOverwritten(isOverwritten), Color(color){};
  ...
  struct DrawableCullingData {
     ...
     * @brief   コンストラクタ
     */
    DrawableCullingData() : IsOverwritten(false), IsCulling(0){};

    /**
     * @brief   コンストラクタ
     */
    DrawableCullingData(csmBool isOverwritten, csmInt32 isCulling)
        : IsOverwritten(isOverwritten), IsCulling(isCulling){};
  ...
  struct PartColorData {
     ...
     * @brief   コンストラクタ
     */
    PartColorData() : IsOverwritten(false), Color(){};

    /**
     * @brief   コンストラクタ
     */
    PartColorData(csmBool isOverwritten,
                  Rendering::CubismRenderer::CubismTextureColor color)
        : IsOverwritten(isOverwritten), Color(color){};
   ...
   * @param[in]   weight      重み
   */
  void SetParameterValue(CubismIdHandle parameterId, csmFloat32 value,
                         csmFloat32 weight = 1.0f);
   ...
   * @param[in]   weight          重み
   */
  void SetParameterValue(csmInt32 parameterIndex, csmFloat32 value,
                         csmFloat32 weight = 1.0f);
   ...
   * @param[in]   weight          重み
   */
  void AddParameterValue(CubismIdHandle parameterId, csmFloat32 value,
                         csmFloat32 weight = 1.0f);
   ...
   * @param[in]   weight          重み
   */
  void AddParameterValue(csmInt32 parameterIndex, csmFloat32 value,
                         csmFloat32 weight = 1.0f);
   ...
   * @param[in]   weight          重み
   */
  void MultiplyParameterValue(CubismIdHandle parameterId, csmFloat32 value,
                              csmFloat32 weight = 1.0f);
   ...
   * @param[in]   weight          重み
   */
  void MultiplyParameterValue(csmInt32 parameterIndex, csmFloat32 value,
                              csmFloat32 weight = 1.0f);
  ...
  /**
   * @deprecated
   * 関数名が誤っていたため、代替となる getDrawableTextureIndex
   * を追加し、この関数は非推奨となりました。
   *
   ...
   * @return  Drawableの頂点リスト
   */
  const Core::csmVector2 *GetDrawableVertexPositions(
   ...
   */
  Rendering::CubismRenderer::CubismBlendMode GetDrawableBlendMode(
      csmInt32 drawableIndex) const;
   ...
   * @retval  false
   * Drawableの表示状態が直近のCubismModel::Update関数で変化していない
   */
  csmBool GetDrawableDynamicFlagVisibilityDidChange(
      csmInt32 drawableIndex) const;
   ...
   * @retval  false
   * Drawableの不透明度が直近のCubismModel::Update関数で変化していない
   */
   ...
   * Drawableの不透明度が直近のCubismModel::Update関数で変化していない
   */
  csmBool GetDrawableDynamicFlagDrawOrderDidChange(
      csmInt32 drawableIndex) const;
   ...
   * @param[in]   drawableIndex   Drawableのインデックス
   * @retval  true
   * Drawableの描画の順序が直近のCubismModel::Update関数で変化した
   * @retval  false
   * Drawableの描画の順序が直近のCubismModel::Update関数で変化していない
   */
  csmBool GetDrawableDynamicFlagRenderOrderDidChange(
      csmInt32 drawableIndex) const;
   ...
   * @retval  false
   * Drawableの頂点情報が直近のCubismModel::Update関数で変化していない
   */
  csmBool GetDrawableDynamicFlagVertexPositionsDidChange(
      csmInt32 drawableIndex) const;
   ...
   * @param[in]   drawableIndex   Drawableのインデックス
   * @retval  true
   * Drawableの乗算色・スクリーン色が直近のCubismModel::Update関数で変化した
   * @retval  false
   * Drawableの乗算色・スクリーン色が直近のCubismModel::Update関数で変化していない
   */
  csmBool GetDrawableDynamicFlagBlendColorDidChange(
      csmInt32 drawableIndex) const;
   ...
   */
  Rendering::CubismRenderer::CubismTextureColor GetMultiplyColor(
      csmInt32 drawableIndex) const;

  /**
   * @brief   drawableのスクリーン色を取得する
   */
  Rendering::CubismRenderer::CubismTextureColor GetScreenColor(
      csmInt32 drawableIndex) const;

  /**
   * @brief   drawableの乗算色を設定する
   */
  void SetMultiplyColor(
   ...
   * @brief   drawableの乗算色を設定する
   */
  void SetMultiplyColor(csmInt32 drawableIndex, csmFloat32 r, csmFloat32 g,
                        csmFloat32 b, csmFloat32 a = 1.0f);
   ...
   * @brief   drawableのスクリーン色を設定する
   */
  void SetScreenColor(csmInt32 drawableIndex, csmFloat32 r, csmFloat32 g,
                      csmFloat32 b, csmFloat32 a = 1.0f);

  /**
   * @brief   partの乗算色を取得する
   */
  Rendering::CubismRenderer::CubismTextureColor GetPartMultiplyColor(
      csmInt32 partIndex) const;

  /**
   * @brief   partの乗算色を取得する
   */
  Rendering::CubismRenderer::CubismTextureColor GetPartScreenColor(
      csmInt32 partIndex) const;

  /**
   * @brief   partのスクリーン色を設定する
   */
  void SetPartMultiplyColor(
      csmInt32 partIndex,
      const Rendering::CubismRenderer::CubismTextureColor &color);
   ...
   * @brief   partの乗算色を設定する
   */
  void SetPartMultiplyColor(csmInt32 partIndex, csmFloat32 r, csmFloat32 g,
                            csmFloat32 b, csmFloat32 a = 1.0f);

  /**
   * @brief   partのスクリーン色を設定する
   */
  void SetPartScreenColor(
      csmInt32 partIndex,
      const Rendering::CubismRenderer::CubismTextureColor &color);
   ...
   * @brief   partのスクリーン色を設定する
   */
  void SetPartScreenColor(csmInt32 partIndex, csmFloat32 r, csmFloat32 g,
                          csmFloat32 b, csmFloat32 a = 1.0f);
   ...
   * @retval  false   ->  モデルの色情報を使用
   */
  csmBool GetOverwriteFlagForDrawableMultiplyColors(
      csmInt32 drawableIndex) const;
   ...
   *        SDK上の色情報を使うならtrue、モデルの色情報を使うならfalse
   */
  void SetOverwriteFlagForDrawableMultiplyColors(csmUint32 drawableIndex,
                                                 csmBool value);
   ...
   *        SDK上の色情報を使うならtrue、モデルの色情報を使うならfalse
   */
  void SetOverwriteFlagForDrawableScreenColors(csmUint32 drawableIndex,
                                               csmBool value);
   ...
   *        SDK上の色情報を使うならtrue、モデルの色情報を使うならfalse
   */
  void SetOverwriteColorForPartMultiplyColors(csmUint32 partIndex,
                                              csmBool value);
   ...
   *        SDK上のカリング設定を使うならtrue、モデルのカリング設定を使うならfalse
   */
  void SetOverwriteFlagForDrawableCullings(csmUint32 drawableIndex,
                                           csmBool value);
 ...
 private:
   ...
   */
  void SetPartColor(csmUint32 partIndex, csmFloat32 r, csmFloat32 g,
  ...
  csmVector<DrawableColorData>
      _userMultiplyColors;  ///< Drawable スクリーン色の配列
  csmVector<DrawableCullingData> _userCullings;  ///< カリング設定の配列
  csmVector<PartColorData> _userPartScreenColors;  ///< Part 乗算色の配列
  csmVector<PartColorData>
      _userPartMultiplyColors;  ///< Part スクリーン色の配列
  csmVector<csmVector<csmUint32> >
      _partChildDrawables;  ///< Partの子DrawableIndexの配列
  csmBool _isOverwrittenModelMultiplyColors;  ///< 乗算色を全て上書きするか？
  csmBool
      _isOverwrittenModelScreenColors;  ///< スクリーン色を全て上書きするか？
  csmBool
      _isOverwrittenCullings;  ///< モデルのカリング設定をすべて上書きするか？
};
