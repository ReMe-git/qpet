...
struct CubismVector2 {
   ...
   * @return  a + bの結果
   */
  friend CubismVector2 operator+(const CubismVector2 &a,
                                 const CubismVector2 &b);
   ...
   */
  friend CubismVector2 operator*(const CubismVector2 &vector,
                                 const csmFloat32 scalar);
   ...
   */
  friend CubismVector2 operator*(const csmFloat32 scalar,
                                 const CubismVector2 &vector);
