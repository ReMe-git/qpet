...
class CubismMath {
 public:
   ...
   */
  static csmFloat32 SinF(csmFloat32 x) { return sinf(x); };
   ...
   */
  static csmFloat32 CosF(csmFloat32 x) { return cosf(x); };
   ...
   *@return   値の絶対値
   */
  static csmFloat32 AbsF(csmFloat32 x) { return std::fabs(x); };
   ...
   *@return   値の平方根
   */
  static csmFloat32 SqrtF(csmFloat32 x) { return sqrtf(x); };
   ...
   * @return 大きい方の値
   */
  static csmFloat32 Max(csmFloat32 l, csmFloat32 r) { return (l > r) ? l : r; }
   ...
   * @return 小さい方の値
   */
  static csmFloat32 Min(csmFloat32 l, csmFloat32 r) { return (l > r) ? r : l; }
   ...
   */
  static csmFloat32 CardanoAlgorithmForBezier(csmFloat32 a, csmFloat32 b,
