 ...
 *
 * @note The set logging level is applied by changing the definition of a group
 * of macros that call logging in the CubismDebug class.
 */
 ...
 *
 * @note Set one of the logging levels from CSM_LOG_LEVEL_VERBOSE to
 * CSM_LOG_LEVEL_OFF.
 */
