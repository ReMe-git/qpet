...
class CubismBreath {
 public:
  ...
  struct BreathParameterData {
     ...
     */
    BreathParameterData(CubismIdHandle parameterId, csmFloat32 offset,
                        csmFloat32 peak, csmFloat32 cycle, csmFloat32 weight)
 ...
 private:
  ...
  csmVector<BreathParameterData>
      _breathParameters;  ///< 呼吸にひもづいているパラメータのリスト
