...
/**
 * IDで指定された目のパラメータが、0のときに閉じるなら true 、1の時に閉じるなら
 * false 。
 */
...
void CubismEyeBlink::SetBlinkingSettings(csmFloat32 closing, csmFloat32 closed,
                                         csmFloat32 opening) {
...
void CubismEyeBlink::SetParameterIds(
    const csmVector<CubismIdHandle> &parameterIds) {
...
void CubismEyeBlink::UpdateParameters(CubismModel *model,
